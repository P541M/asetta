...
export const CURATED_ICONS: IconData[] = [
  ...
  { id: "heart", icon: HiHeart, name: "Heart", keywords: ["love", "passion", "emotion", "care"] },
  {
    ...
    icon: HiStar,
    name: "Star",
    keywords: ["favorite", "special", "achievement", "excellent"],
  },
  {
    id: "briefcase",
    icon: HiBriefcase,
    name: "Briefcase",
    keywords: ["work", "business", "career", "professional"],
  },
  {
    id: "book",
    icon: HiBookOpen,
    name: "Book",
    keywords: ["book", "reading", "study", "student", "academic"],
  },
  {
    id: "computer",
    icon: HiDesktopComputer,
    name: "Computer",
    keywords: ["computer", "tech", "development", "developer"],
  },
  {
    id: "globe",
    icon: HiGlobe,
    name: "Globe",
    keywords: ["world", "international", "travel", "global"],
  },
  {
    id: "camera",
    icon: FiCamera,
    name: "Camera",
    keywords: ["photography", "visual", "art", "creative"],
  },
  {
    id: "music",
    icon: HiMusicNote,
    name: "Music",
    keywords: ["music", "audio", "sound", "musician"],
  },
  {
    id: "coffee",
    icon: FiCoffee,
    name: "Coffee",
    keywords: ["coffee", "energy", "morning", "caffeine"],
  },
  { id: "sun", icon: HiSun, name: "Sun", keywords: ["bright", "positive", "energy", "sunny"] },
  {
    ...
    icon: HiSparkles,
    name: "Sparkles",
    keywords: ["magic", "creative", "inspiration", "special"],
  },
  {
    id: "target",
    icon: FiTarget,
    name: "Target",
    keywords: ["goal", "focus", "achievement", "aim"],
  },
  {
    id: "rocket",
    icon: RiRocketLine,
    name: "Rocket",
    keywords: ["launch", "progress", "ambition", "growth"],
  },
  {
    id: "lightning",
    icon: HiLightningBolt,
    name: "Lightning",
    keywords: ["energy", "power", "dynamic", "fast"],
  },
];
