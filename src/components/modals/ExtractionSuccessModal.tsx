...
const ExtractionSuccessModal: React.FC<ExtractionSuccessModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="bg-light-bg-primary dark:bg-dark-bg-secondary rounded-2xl shadow-2xl max-w-lg w-full mx-4 animate-scale-in"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header with Success Animation */}
        <div className="p-8 text-center border-b border-light-border-primary dark:border-dark-border-primary">
          <div className="mx-auto flex items-center justify-center w-16 h-16 bg-green-100 dark:bg-green-900/30 rounded-full mb-4 animate-bounce">
            <svg
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-light-bg-tertiary dark:bg-dark-bg-tertiary rounded-xl p-4 text-center">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                {result.courseBreakdown.map((course, index) => (
                  <div
                    key={index}
                    className="flex items-center justify-between p-3 bg-light-bg-tertiary dark:bg-dark-bg-tertiary rounded-lg"
                  >
          ...
          {result.processingTime && (
            <div className="flex items-center justify-center space-x-2 text-sm text-light-text-tertiary dark:text-dark-text-tertiary">
        ...
        <div className="p-6 pt-0 space-y-3">
          <button
            ...
            className="w-full bg-light-button-primary hover:bg-light-button-primary-hover dark:bg-dark-button-primary dark:hover:bg-dark-button-primary-hover text-white font-medium py-3 px-4 rounded-xl transition-all duration-200 transform hover:scale-[1.02] shadow-lg hover:shadow-xl flex items-center justify-center space-x-2"
          >
          ...
          <button
            onClick={onClose}
            className="w-full text-light-text-secondary dark:text-dark-text-secondary hover:text-light-text-primary dark:hover:text-dark-text-primary py-2 text-sm transition-colors"
          >
            I&apos;ll do this later
          </button>
        </div>
