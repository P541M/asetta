...
const StatusSelect: React.FC<StatusSelectProps> = ({
  ...
  const handleSelect = useCallback((optionValue: StatusValue) => {
    ...
    >
      ...
      <button
        ...
        className={`
          ...
          ${isOpen ? 'ring-2 ring-light-focus-ring dark:ring-dark-focus-ring border-light-button-primary dark:border-dark-button-primary' : ''}
        `}
      >
        ...
        {/* Dropdown Arrow */}
        <svg 
          className={`w-4 h-4 ml-2 flex-shrink-0 transition-transform duration-200 text-light-text-tertiary dark:text-dark-text-tertiary ${
